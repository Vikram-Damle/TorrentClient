...
module.exports.download=(parsedTorrent,peer_conns)=>{
    let fd= utils.openOverwrite(config.DOWNLOADPATH);
    torrent=parsedTorrent;
    let pieces=new Array();
    let peers = new Array();
    const blockPerPiece = torrent.pieceLength/config.BLOCKLENGTH;
    ...
    let bfFile=utils.openOverwrite(config.BITFIELDPATH);
